...
<div class="container-fluid px-4">
    ...
    <div class="form-container">
        <div class="form-card">
            <form id="formUsuario" class="user" method="POST" action="{{ route('usuarios_update', $usuario->id) }}">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input class="form-control form-control-user" type="password" id="contrasena-id" placeholder="Contraseña" required name="password" value="{{ $usuario->password }}" title="">
                    </div>
                </div>
