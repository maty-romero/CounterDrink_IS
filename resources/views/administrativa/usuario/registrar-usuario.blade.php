                            ...
                            <div class="form-card">
                                <form class="user">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                                <label class="col-form-label" for="userType">Tipo de usuario:</label>
                                            <select class="form-control form-control-user" name="userType" required="true">
                                    ...
                                    type="submit">Registrar empleado</button>
                                </form>
                            </div>
                        </div>
                    </div>
