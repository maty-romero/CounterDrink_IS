...
return [
    ...
    'between' => [
        ...
        'file' => 'El campo :attribute debe ser un archivo entre :min y :max kilobytes.',
        'string' => 'El campo :attribute debe ser un texto entre :min y :max caracteres.',
    ...
    'min' => [
        'numeric' => 'El valor de campo :attribute debe ser al menos :min.',
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto nos ayuda a
    | mantener las líneas personalizadas para una regla de
    | validación específica dada en lugar de dejar el atributo
    | en la línea de lenguaje "atributo.regla" predeterminada.
    |
    */
